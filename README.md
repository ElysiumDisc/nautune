...
120 channels from the Other People Network catalog, dialled 0–333 with seek-to-nearest-available. The full list lives in [`lib/data/network_channels.dart`](lib/data/network_channels.dart) and is also browsable in-app on the Network screen.
